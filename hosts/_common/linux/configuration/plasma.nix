{ ... }: {
  plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-bf82d438-bf8f-4301-a462-976b9ada5adf" = [ ];
      ...
      "kwin"."Walk Through Windows of Current Application" = [ "Meta+`" "Alt+`,Alt+`,Walk Through Windows of Current Application" ];
      "kwin"."Walk Through Windows of Current Application (Reverse)" = [ "Meta+~" "Alt+~,Alt+~,Walk Through Windows of Current Application (Reverse)" ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."bf82d438-bf8f-4301-a462-976b9ada5adf" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "bf82d438-bf8f-4301-a462-976b9ada5adf";
      "kcminputrc"."Libinput/1133/16465/Logitech M510"."PointerAccelerationProfile" = 1;
      ...
      "kwinrc"."Desktops"."Id_1" = "85e5a6f0-8263-4659-b13f-da761b626a90";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/5304a053-1eba-51e1-a36e-927217e4a1bf"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/85e5a6f0-8263-4659-b13f-da761b626a90/aa64a942-04dc-4bf1-91fa-175a9504ff5b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
